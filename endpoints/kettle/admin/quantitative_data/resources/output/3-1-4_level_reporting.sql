...
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.010399687279302669);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.02104445851911139);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.0410718481086523);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.04641512249730622);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.17004689168038187);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.1752528971893979);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.2166575712965568);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.23168645733710436);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.3002595636512325);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.3154925735525025);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.33365111046297674);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.33909845890011514);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.36055261798513444);

SET @profileID = (SELECT p.id FROM profile p INNER JOIN nuts n ON p.nuts_id=n.id WHERE n.country_code="AT" AND activity_sector_id IS NULL AND age_group_id IS NULL AND answer_id IS NULL AND company_size_id IS NULL AND currency_id IS NULL AND gender_id IS NULL AND illness_id IS NULL AND subindicator_id IS NULL AND year IS NULL);
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.4425050957769573);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.5318783766892401);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.563737194139292);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.5775988268722534);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.5836875921540813);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.6218073475291608);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.6407736247668436);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.6923872947665316);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.7535056817383567);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.9012632075884527);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Level of reporting of non-fatal accidents");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.9981262192122771);
