...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.8999999999999999);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.8500000000000001);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.9099999999999999);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.8899999999999999);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.7899999999999999);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.8600000000000001);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.8300000000000001);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.8400000000000001);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Satisfaction with working conditions");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.9199999999999999);
