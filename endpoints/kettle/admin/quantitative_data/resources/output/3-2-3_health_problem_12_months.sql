...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Health problem in the last 12 months");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.047);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Health problem in the last 12 months");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.028999999999999998);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Health problem in the last 12 months");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.077);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Health problem in the last 12 months");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.059000000000000004);
...
SET @indicatorID = (SELECT id FROM indicator WHERE name="Health problem in the last 12 months");
SET @datasetID = (SELECT dataset_id FROM indicators_in_dataset WHERE indicator_id=@indicatorID);
INSERT INTO value (dataset_id, indicator_id, profile_id, value)VALUES (@datasetID, @indicatorID, @profileID, 0.228);
