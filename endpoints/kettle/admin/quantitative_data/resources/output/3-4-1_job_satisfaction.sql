SET @answerId = (SELECT a.id FROM split_answe a INNER JOIN translation t ON a.literal_id=t.literal_id WHERE t.text="Not at all satisfied");
SET @nutsId = (SELECT id FROM nuts WHERE country_code="AT");
INSERT INTO profile (nuts_id, answer_id) VALUE (@nutsId, @answerId);

SET @answerId = (SELECT a.id FROM split_answe a INNER JOIN translation t ON a.literal_id=t.literal_id WHERE t.text="Not very satisfied");
SET @nutsId = (SELECT id FROM nuts WHERE country_code="AT");
INSERT INTO profile (nuts_id, answer_id) VALUE (@nutsId, @answerId);

SET @answerId = (SELECT a.id FROM split_answe a INNER JOIN translation t ON a.literal_id=t.literal_id WHERE t.text="Satisfied");
SET @nutsId = (SELECT id FROM nuts WHERE country_code="AT");
INSERT INTO profile (nuts_id, answer_id) VALUE (@nutsId, @answerId);

SET @answerId = (SELECT a.id FROM split_answe a INNER JOIN translation t ON a.literal_id=t.literal_id WHERE t.text="Very satisfied");
SET @nutsId = (SELECT id FROM nuts WHERE country_code="AT");
INSERT INTO profile (nuts_id, answer_id) VALUE (@nutsId, @answerId);
